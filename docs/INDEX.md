...
- [Sources](SOURCES.md): research parallels and upstream APIs.
- [Validation](VALIDATION.md): observed checks and limitations.
- [Templates](../templates/README.md), [examples](../examples/README.md), [skills](../skills/README.md).
