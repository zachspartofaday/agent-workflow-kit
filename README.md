...
Research influences, including NVIDIA AVO and Yichen Huang’s sum-product proof harness, are credited in [Sources](docs/SOURCES.md). No affiliation, endorsement or benchmark equivalence is implied.
